...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const rows = document.querySelectorAll(".menu");
  ...
  function open(panel) {
    ...
    cssVar.style.setProperty('--panel-height', panel.scrollHeight);
  }
  ...
  function toggle(key) {
    const row = document.querySelector(`.menu[data-target="${key}"]`);
    ...
    if (window.scrollY < cssVar.style.getPropertyValue('--panel-height')) {
      y = row.getBoundingClientRect().top + window.scrollY;
    } else {
      y = row.getBoundingClientRect().top + window.scrollY - cssVar.style.getPropertyValue('--panel-height');
    }

    console.log("y:"+ y);
    console.log("scroll:"+ window.scrollY);
    console.log("top:"+ row.getBoundingClientRect().top);
    console.log("===============================");
